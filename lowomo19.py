...
u_so2_b = 1e-6*p_surf_earth/Earth_atm.planet.g*sulfur.mu_so2/mu_air # [kg/m3]
...
t = PrettyTable(['obs S','model param',' # S atoms','# S moles', 'S kg', 'SO2 ppm'])

t.add_row(['aerosol','best','%1.3E'%best_aero_Earth.N_S_atm,
           '%1.3E'%best_aero_Earth.mol_S_atm,
           '%1.3E'%best_aero_Earth.mass_S_atm,'%1.3E'%(best_aero_Earth.p_so2_surf/p_surf_earth*1e6)])

t.add_row(['aerosol','limiting M','%1.3E'%lim_aero_M_Earth.N_S_atm,
           '%1.3E'%lim_aero_M_Earth.mol_S_atm,
           '%1.3E'%lim_aero_M_Earth.mass_S_atm,'%1.3E'%(lim_aero_M_Earth.p_so2_surf/p_surf_earth*1e6)])

t.add_row(['aerosol','limiting G','%1.3E'%lim_aero_G_Earth.N_S_atm,
           '%1.3E'%lim_aero_G_Earth.mol_S_atm,
           '%1.3E'%lim_aero_G_Earth.mass_S_atm,'%1.3E'%(lim_aero_G_Earth.p_so2_surf/p_surf_earth*1e6)])

t.add_row(['gas','best','%1.3E'%best_gas_Earth.N_S_atm,
           '%1.3E'%best_gas_Earth.mol_S_atm,
           '%1.3E'%best_gas_Earth.mass_S_atm,'%1.3E'%(best_gas_Earth.p_so2_surf/p_surf_earth*1e6)])

t.add_row(['gas','limiting','%1.3E'%lim_gas_Earth.N_S_atm,
           '%1.3E'%lim_gas_Earth.mol_S_atm,
           '%1.3E'%lim_gas_Earth.mass_S_atm,'%1.3E'%(lim_gas_Earth.p_so2_surf/p_surf_earth*1e6)])
